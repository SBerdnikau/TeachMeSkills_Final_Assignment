...
public interface Constants {
    ...
    int ERROR_CODE_STATISTIC = 400;
    int ERROR_CODE_UPLOAD = 500;

    String PATH_TO_STATISTIC_FILE = "src/main/resources/report/total_statistic.txt";
    ...
    String PATH_TO_REPORT_FILE = "src/main/resources/report/total_statistic.txt";
    ...
    String KEY_S3_NAME_FILE_REPORT = "_total_statistic.txt";
    ...
    String MESSAGE_FILE_RECORD_SUCCESS = "The file is was recorded successful";


    String DELIMITER_1 = "===================================================================";
    String DELIMITER_2 = "-------------------------------------------------------------------";
    String HEAD_STATISTIC = "====================FINANCIAL STATISTICS===========================";
    String TOTAL_AMOUNT_STATISTIC = "\nType\t\t\t\t\t|\tTotal amount\n";
    String CHECK_AMOUNT_STATISTIC = "\nTotal Check Amount:\t\t|\t%.2f";
    String INVOICE_AMOUNT_STATISTIC = "\nTotal Invoice Amount:\t|\t%.2f";
    String ORDER_AMOUNT_STATISTIC = "\nTotal Order Amount:\t\t|\t%.2f\n";
}
